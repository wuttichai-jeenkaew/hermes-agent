...
class TurnRunner:
    ...
    def _approval_notify_sync(self, approval_data: dict) -> None:
        ...
        desc = _redact_gateway_user_facing_secrets(approval_data.get("description", "dangerous command"))
            ...
            try:
                fut = self._schedule(
                    adapter.send_exec_approval(
                        ...
                        description=desc, metadata=_approval_metadata, **flags,
                    ),
        ...
        msg = _format_exec_approval_fallback(
            ...
            request_id=str(approval_data.get("request_id") or ""), **flags
        )
        try:
