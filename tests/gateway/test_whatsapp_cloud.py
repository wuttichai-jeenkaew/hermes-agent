...
class TestDispatchInteractiveReplyApproval:
    ...
    async def test_approve_tap_calls_resolver_and_confirms(self, monkeypatch):
        ...
        monkeypatch.setattr(
            ...
            lambda session_key, choice, **kwargs: calls.append((session_key, choice, kwargs.get("request_id"))) or 1,
        )
        ...
        assert handled is True
        assert calls == [("sess-app-1", "once", "req-whatsapp-1")]
